...
class Colors {
    ...
    public static let blueCollection = [
        aliceblue,
        lavender,
        powderblue,
        lightblue,
    ...
    public static let magentaCollection = [
        magenta,
        fuchsia,
        darkmagenta,
        purple,
    ...
    public static let cyanCollection = [
        lightcyan,
        cyan,
        aqua,
        aquamarine,
    ...
    public static let greenCollection = [
        lawngreen,
        chartreuse,
        limegreen,
        lime,
    ...
    public static let grayCollection = [
        gainsboro,
        lightgray,
        silver,
        darkgray,
    ...
    public static let maroonCollection = [
        maroon,
        darkred,
        brown,
        firebrick,
    ...
    public static let orangeCollection = [
        coral,
        tomato,
        orangered,
        gold,
    ...
    public static let pinkCollection = [
        pink,
        lightpink,
        hotpink,
        deeppink,
    ...
    public static let redCollection = [
        lightsalmon,
        salmon,
        darksalmon,
        lightcoral,
    ...
    public static let whiteCollection = [
        white,
        snow,
        honeydew,
        mintcream,
    ...
    public static let yellowCollection = [
        lightyellow,
        lemonchiffon,
    ...
    public static let purpleCollection = [
        lavender,
        thistle,
        plum,
        violet,
    ...
    public static let allColorsCollection = [
        lavender,
        thistle,
        plum,
        violet,
